    ...
    return (
        <div className="mx-auto max-w-2xl space-y-6">
            <Card className="rounded-3xl border-none shadow-sm ring-1 ring-border">
                <CardHeader>
                    <CardTitle className="text-2xl font-bold text-lime-500">My Profile</CardTitle>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="grid gap-2">
                            ...
                            <div className="flex items-center gap-2 rounded-md border border-border bg-muted px-3 py-2 text-sm text-muted-foreground">
                                <span className={`h-2 w-2 rounded-full ${profile?.role === 'admin' ? 'bg-purple-500' : 'bg-green-500'}`} />
